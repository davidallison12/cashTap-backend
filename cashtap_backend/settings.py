"""
Django settings for cashtap_backend project.
...
# Loading .env file so I can use variables
load_dotenv()
...
WSGI_APPLICATION = 'cashtap_backend.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'https://cashtap-frontend.herokuapp.com'
]
